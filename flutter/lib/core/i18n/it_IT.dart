...
const Map<String, String> itIT = {
  ...
  'trial.expired.title': 'Prova gratuita terminata',
  'trial.expired.msg': 'Il tuo periodo di prova di 15 giorni è terminato. Per continuare a usare RadioKit Regia inserisci una chiave valida o scrivici per rinnovare.',
  'trial.expired.cta': 'Inserisci una nuova chiave',
  'trial.expired.contact': 'Assistenza: info@radiokit.io',
  ...
  'stats.eyebrow':    'STATISTICHE ASCOLTI',
  'stats.liveNow':    'Live adesso',
  'stats.listeners':  'ascoltatori',
  'stats.avg24h':     'Media 24h',
  'stats.peak24h':    'Picco 24h',
  'stats.avg7d':      'Media 7g',
  'stats.peak7d':     'Picco 7g',
  'stats.realtime':   'Realtime',
  'stats.last60min':  'ultimi 60 min',
  'stats.history':    'Andamento',
  'stats.avg':        'Media',
  'stats.peak':       'Picco',
  ...
  'audio.jingle.hint':   'File pre-prodotto — invio diretto, nessuna modifica',
  'audio.spot.hint':     'Spot pubblicitario — invio diretto, nessuna modifica',
  'audio.normalize':     'Normalizza a 0 dB',
  'audio.normalize.hint':'Uniforma il volume con i brani in playlist (raccomandato)',
  'audio.denoise':       'Riduci rumore',
  'audio.denoise.hint':  'Toglie fruscio e rumore di fondo dalla voce',
  'audio.gain':          'Volume',
  ...
  'audio.err.fx_failed':   'Elaborazione audio fallita: invio l\'originale',
