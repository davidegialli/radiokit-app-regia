...
const MOCK_TRACKS = [
  ...
  { id: 't5', title: 'Codice Postale RK',    artist: 'Onda Lirica',         album: 'Demo',             dur: '2:58', cover: 0 },
...
const MOCK_JINGLES = [
  ...
  { id: 'j5', name: 'Sweeper Afternoon',         dur: '0:10', tag: 'SWEEP', uses: 38  },
...
const MOCK_PUSH = [
  ...
  { id: 'p4', title: 'Afternoon Show inizia ora',  body: 'Con Andrea Vella', t: '17:00', sent: 3890, opens: 412, kind: 'live' },
];

const MOCK_SCHEDULE = [
  { time: '06:00', show: 'Sveglia RadioKit',     host: 'Lia Marconi',     live: false },
  { time: '09:00', show: 'Mattino Aperto',       host: 'Andrea Vella',    live: false },
  { time: '12:00', show: 'Pranzo & Musica',      host: 'AutoDJ',           live: false },
  { time: '15:00', show: 'Pomeriggio RK',        host: 'Marta Lenzi',     live: true,  current: true },
  { time: '18:00', show: 'Afternoon Show',       host: 'Andrea Vella',    live: false },
...
const MOCK_HISTORY = [
  ...
  { time: '22:24', title: 'Codice Postale RK', artist: 'Onda Lirica',    dur: '2:58' },
